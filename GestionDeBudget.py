...
try:
  ...
  # Vérifiez le choix ou l'option ou l'entrée de l'utilisateur
    if option == 0:
      ...
      cursor.execute(
      "CREATE TABLE IF NOT EXISTS GestionDeDepenses (id INTEGER PRIMARY KEY AUTOINCREMENT,EntrerUtilisateur TEXT, DonneUtilisateur TEXT)")
      ...
      cursor.execute(
      "CREATE TABLE IF NOT EXISTS GestionDeRevenu (id INTEGER PRIMARY KEY AUTOINCREMENT,TypeBusiness TEXT, ChiffreBusiness TEXT)")
